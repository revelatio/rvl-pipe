...
export declare const each: (...tasks: (AsyncFunction | SyncFunction)[]) => AsyncFunction;
export declare const should: (predicate: SyncPredicate, errorCode: string | Error) => AsyncFunction;
