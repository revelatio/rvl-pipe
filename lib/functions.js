...
module.exports.set = prop => ctx => Promise.resolve(R.merge(ctx || {}, passData(prop, ctx || {})))
...
module.exports.each = (...tasks) => ctx => Promise.resolve(tasks.reduce((result, task) => result.then(task), Promise.resolve(ctx || {})))
